...
export default function DeliverablesPage() {
  ...
  useEffect(() => {
    const loadDeliverablesData = async () => {
      if (isLoadingSettings || isLoadingProjects) return;
      ...
      console.log("Loading deliverables and client galleries from backend API...");
  ...
  }, [isLoadingSettings, isLoadingProjects, allProjectsFromContext]);
